    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button type="button" class="btn btn-default btn-lg" id="publishBtn">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 发布新的信息
            </button>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">团队信息管理</div>
...
<div class="container" id="publishBox">
    <div class="panel panel-primary" style="width: 800px;margin: 0 auto;position: absolute;left:0;right:0;bottom: 10px;z-index: 1111;">
        <div class="panel-heading">发布新的信息</div>
        <div class="panel-body" style="margin: 0;padding-bottom: 10px;">
            <form class="form-inline form" style="margin: 0 auto;">
                <div class="form-group">
                    ...
                    <br><br>
                    <textarea rows="3" cols="100" class="form-control" placeholder="信息内容"></textarea><br><br>
